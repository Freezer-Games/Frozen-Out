...
Shader "FrozenOut/ToonShaderTransparent"
{
	Properties
	{
		...
		[Toggle]_Selected1("Selected", Float) = 0
		_SelectedColor1("Selected Color", Color) = (0,0,0,0)
		_SelectedIntensity1("Selected Intensity", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		uniform float _Selected1;
		uniform float4 _SelectedColor1;
		uniform float _SelectedIntensity1;
		...
		void surf( Input i , inout SurfaceOutputCustomLightingCustom o )
		{
			...
			o.Emission = (( _Selected1 )?( ( _SelectedColor1 * _SelectedIntensity1 ) ):( float4( 0,0,0,0 ) )).rgb;
		}
...
/*ASEBEGIN
Version=17700
0;9;1920;1010;-2542.596;1792.672;1;True;True
...
Node;AmplifyShaderEditor.ColorNode;153;3022.546,-1529.172;Inherit;False;Property;_SelectedColor1;Selected Color;18;0;Create;True;0;0;False;0;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;152;2982.246,-1337.872;Inherit;False;Property;_SelectedIntensity1;Selected Intensity;19;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;155;3591.547,-1333.373;Inherit;False;Property;_Selected1;Selected;17;0;Create;True;0;0;False;0;0;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=1D33FBF69C9175FDFDEC7551698C91DFB9D2E329