...
Shader "Custom/Snow"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v )
		{
			...
			float3 temp_output_33_0 = ( ase_vertexNormal * float3( 0,1,0 ) );
			...
			float4 temp_output_22_0 = (float4( 0,0,0,0 ) + (temp_output_12_0 - float4( 0,0,0,0 )) * (float4( appendResult32 , 0.0 ) - float4( 0,0,0,0 )) / (float4( 1,1,1,0 ) - float4( 0,0,0,0 )));
			v.vertex.xyz += ( float4( temp_output_33_0 , 0.0 ) + temp_output_22_0 ).rgb;
		}
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float layeredBlendVar56 = (temp_output_28_0).r;
			float4 layeredBlend56 = ( lerp( ( tex2D( _SnowMap, uv_SnowMap ) - temp_output_28_0 ),tex2D( _GroundMap, uv_GroundMap ) , layeredBlendVar56 ) );
			o.Albedo = layeredBlend56.rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=17700
0;0;1920;1019;2565.669;1007.977;2.04827;True;True
...
Node;AmplifyShaderEditor.TexturePropertyNode;10;-2513.593,-717.6364;Inherit;True;Property;_SnowMap;SnowMap;5;0;Create;True;0;0;False;0;4112a019314dad94f9ffc2f8481f31bc;1e2f276f8cc4f694881058b4bdf0a459;False;white;Auto;Texture2D;-1;0;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;11;-2498.021,-375.9096;Inherit;True;Property;_GroundMap;GroundMap;6;0;Create;True;0;0;False;0;b5c231fa3c5fe964f8d11551df320603;b5c231fa3c5fe964f8d11551df320603;False;white;Auto;Texture2D;-1;0;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.ComponentMaskNode;51;-1215.188,-825.452;Inherit;False;True;False;False;False;1;0;COLOR;0,0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;35;-883.2861,140.5562;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=CF9A4C6D8930EF4B6E31215AF25267BE5AF47714