...
{
    public class ClosestPromptController : DialoguePromptController
    {
        ...
        public override void Open(DialogueActer acter)
        {
            acter.OnDeselected();
        ...
        public override void Close(DialogueActer acter)
        {
